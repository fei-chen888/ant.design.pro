...
export interface IStoreServiceListAllOffline extends IPageBase {}
/**
 * 商店相关服务接口
 */
export namespace storeService {
     ...
     * 线下门店列表接口
     */
    export function listAllOffline(params: IStoreServiceListAllOffline) {
    ...
    export function getOfflineStoreById(storeId: number) {
        return request.get<IResponseBase<IListOfflineStore>>('/store/lqx/stores/detail', {
            params: {
                storeId
            }
        })
